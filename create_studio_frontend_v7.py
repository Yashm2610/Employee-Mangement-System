...
<style>
    ...
    /* Payslip Skeleton Grid (Excel-like) */
    .skeleton-grid {
        position: absolute; top: 0; left: 0; right: 0; bottom: 0;
        padding: 20px; pointer-events: none; font-family: Arial, sans-serif;
    }
...
<div class="studio-container position-relative">
    ...
    <div class="sidebar-left">
        ...
        <div class="form-section">
            ...
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Company"><input type="text" class="field-value-input" value="Apex Global Tech"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Address"><input type="text" class="field-value-input" value="123 Tech Park"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Month"><input type="text" class="field-value-input" value="June 2026"></div></div>
        </div>
    ...
    <div class="workspace">
        ...
        <div class="canvas-scroll-area">
            <div class="a4-canvas" id="canvas">
                <!-- STRUCTURAL SKELETON (Excel Inspired) -->
                <div class="skeleton-grid">
                    <div style="border: 2px solid #556b2f; padding: 4px;">
                        <div style="border: 1px solid #556b2f;">
                            <!-- Header Row -->
                            <div style="display:flex; border-bottom: 1px solid #556b2f; min-height: 80px;">
                                <div style="width: 30%; background-color: #6b843a; color: white; display:flex; align-items:center; justify-content:center; font-weight:bold; font-size:16px;">
                                    <span class="placeholder-text" style="color:#e0e0e0; font-weight:normal; font-size:14px;">[Company Header]</span>
                                </div>
                                <div style="width: 40%; display:flex; flex-direction:column; border-left: 1px solid #556b2f; border-right: 1px solid #556b2f;">
                                    <div style="flex:1; display:flex; align-items:center; justify-content:center; font-size:24px; font-weight:bold; letter-spacing:1px; border-bottom: 1px solid #556b2f;">SALARY SLIP</div>
                                    <div style="height:30px; display:flex; align-items:center; justify-content:center; font-weight:bold;">
                                        <span class="placeholder-text" style="color:#aaa; font-weight:normal;">[Month Year]</span>
                                    </div>
                                </div>
                                <div style="width: 30%; background-image: radial-gradient(#aaa 15%, transparent 16%); background-size: 8px 8px; background-color: #d1dcab; display:flex; align-items:center; justify-content:center; font-size:20px; font-weight:bold; letter-spacing:1px;">
                                    CONFIDENTIAL
                                </div>
                            </div>

                            <!-- Employee Info -->
                            <div style="display:flex; border-bottom: 1px solid #556b2f; min-height: 120px;">
                                <div style="flex:1; border-right: 1px solid #556b2f; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Name, ID, etc.]</span>
                                </div>
                                <div style="flex:1; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Title, Dept, etc.]</span>
                                </div>
                            </div>

                            <!-- Table Header -->
                            <div style="display:flex; background-color: #6b843a; color: white; font-weight:bold; border-bottom: 1px solid #556b2f;">
                                <div style="width: 50%; padding: 8px; text-align:center; border-right: 1px solid #556b2f;">Description</div>
                                <div style="width: 25%; padding: 8px; text-align:center; border-right: 1px solid #556b2f;">Earnings</div>
                                <div style="width: 25%; padding: 8px; text-align:center;">Deductions</div>
                            </div>

                            <!-- Table Body -->
                            <div style="display:flex; min-height: 350px; border-bottom: 1px solid #556b2f;">
                                <div style="width: 50%; border-right: 1px solid #556b2f; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Item Labels Here]</span>
                                </div>
                                <div style="width: 25%; border-right: 1px solid #556b2f; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Earning Values]</span>
                                </div>
                                <div style="width: 25%; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Deduction Values]</span>
                                </div>
                            </div>

                            <!-- Totals -->
                            <div style="display:flex; border-bottom: 1px solid #556b2f; font-weight:bold;">
                                <div style="width: 50%; padding: 8px; border-right: 1px solid #556b2f;">Total</div>
                                <div style="width: 25%; padding: 8px; border-right: 1px solid #556b2f; text-align:right;">
                                    <span class="placeholder-text" style="color:#aaa;">[Total Earn]</span>
                                </div>
                                <div style="width: 25%; padding: 8px; text-align:right;">
                                    <span class="placeholder-text" style="color:#aaa;">[Total Ded]</span>
                                </div>
                            </div>
                            ...
                            <div style="display:flex; min-height: 120px;">
                                <div style="width: 50%; border-right: 1px solid #556b2f; padding: 10px;">
                                    <span class="placeholder-text" style="color:#aaa;">[Drop Bank & Payment Info]</span>
                                </div>
                                <div style="width: 50%; display:flex; flex-direction:column;">
                                    <div style="background-color: #6b843a; color: white; padding: 8px; text-align:center; font-weight:bold; letter-spacing:1px; border-bottom: 1px solid #556b2f;">NET PAY</div>
                                    <div style="background-color: #e3ebd1; flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; border-bottom: 1px solid #556b2f; font-size: 20px; font-weight: bold;">
                                        <span class="placeholder-text" style="color:#aaa; font-size:14px; font-weight:normal;">[Drop Net Amount]</span>
                                    </div>
                                    <div style="padding: 15px; text-align:center; font-style:italic;">
                                        <span class="placeholder-text" style="color:#aaa; font-style:normal;">[Drop Amount in Words]</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
print("Studio 7.0 generated with Excel-inspired Skeleton Design.")
