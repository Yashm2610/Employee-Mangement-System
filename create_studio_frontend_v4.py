...
<style>
    ...
    /* Dropped Canvas Element */
    .canvas-field {
        position: absolute; padding: 5px 10px; cursor: move; box-sizing: border-box;
        font-size: 14px; white-space: nowrap; border: 1px dashed transparent;
        display: flex; gap: 8px; align-items: center;
    }
    .canvas-field:hover { border-color: #b0c4de; }
    .canvas-field.selected { border: 1px solid #0d6efd; background: rgba(13, 110, 253, 0.05); }
    ...
    .canvas-field.selected .resize-handle { display: block; }
...
<div class="studio-container">
    ...
    <div class="sidebar-left">
        <div class="form-section bg-light text-center py-2">
            <span class="fs-7 fw-bold text-primary">Data Fields</span><br>
            <span class="fs-7 text-muted" style="font-size:10px;">Type values, then drag ☰ onto canvas</span>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Employee ID">
                    <input type="text" class="field-value-input" value="EMP-001">
                </div>
            </div>
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Employee Name">
                    <input type="text" class="field-value-input" value="Rahul Sharma">
                </div>
            </div>
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Department">
                    <input type="text" class="field-value-input" value="Engineering">
                </div>
            </div>
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Designation">
                    <input type="text" class="field-value-input" value="Software Engineer">
                </div>
            </div>
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Bank Name">
                    <input type="text" class="field-value-input" value="HDFC Bank">
                </div>
            </div>
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap">
                    <input type="text" class="field-label-input" value="Account No.">
                    <input type="text" class="field-value-input" value="******6789">
                </div>
            </div>
        </div>
            ...
            <div id="earnings-list">
                <div class="field-row drag-source">
                    ...
                    <div class="field-input-wrap border-success">
                        ...
                        <input type="text" class="field-value-input" value="65,000">
                    </div>
                </div>
                <div class="field-row drag-source">
                    <i class="bi bi-list field-drag"></i>
                    <div class="field-input-wrap border-success">
                        <input type="text" class="field-label-input bg-light" value="HRA">
                        <input type="text" class="field-value-input" value="26,000">
                    </div>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div id="deductions-list">
                <div class="field-row drag-source">
                    <i class="bi bi-list field-drag"></i>
                    <div class="field-input-wrap border-danger">
                        <input type="text" class="field-label-input bg-light" value="PF">
                        <input type="text" class="field-value-input" value="1,800">
                    </div>
                </div>
                <div class="field-row drag-source">
                    <i class="bi bi-list field-drag"></i>
                    <div class="field-input-wrap border-danger">
                        <input type="text" class="field-label-input bg-light" value="Income Tax">
                        <input type="text" class="field-value-input" value="12,000">
                    </div>
                </div>
            </div>
        ...
        <div class="form-section mt-auto">
            ...
            <div class="field-row drag-source">
                <i class="bi bi-list field-drag"></i>
                <div class="field-input-wrap border-primary">
                    <input type="text" class="field-label-input bg-primary text-white" value="Net Payable">
                    <input type="text" class="field-value-input fw-bold" value="113,000">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="workspace">
        ...
        <div class="canvas-scroll-area">
            <!-- Completely Blank A4 Canvas -->
            <div class="a4-canvas" id="canvas">
                <div style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); color:#ccc; font-size:24px; font-weight:bold; pointer-events:none;" id="blank-msg">Drag fields here</div>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar-right">
        ...
        <div id="prop-empty" class="text-center py-5 text-muted">
            ...
            <p class="mt-3 fs-7 px-3">Select a dropped field on the canvas to edit its layout and styles.</p>
        </div>
        
        <div id="prop-form" style="display:none;">
            <div class="prop-section border-bottom">
                <div class="prop-label">Edit Label</div>
                <input type="text" id="prop-lbl" class="prop-input mb-3" oninput="updateSelectedText()">
                
                <div class="prop-label">Edit Value</div>
            ...
            <div class="prop-section">
                ...
                <div class="mt-3">
                    ...
                    <div class="btn-group w-100">
                        <button class="btn btn-sm btn-outline-secondary" onclick="toggleStyle('bold')" id="btn-bold">B</button>
                        <button class="btn btn-sm btn-outline-secondary" onclick="toggleStyle('italic')" id="btn-italic">I</button>
                    </div>
                </div>
            </div>
    ...
    let html = `
        <div class="field-row drag-source">
            ...
            <div class="field-input-wrap ${borderCls}">
                <input type="text" class="field-label-input bg-light" value="New ${defaultLbl}">
                <input type="text" class="field-value-input" value="${defaultVal}">
            </div>
        </div>
    `;
...
interact('.drag-source').draggable({
    ...
    listeners: {
            ...
            saveState();
            let blankMsg = document.getElementById('blank-msg');
            if(blankMsg) blankMsg.style.display = 'none';
            
            let newEl = document.createElement('div');
            newEl.className = 'canvas-field';
            
            // Default drop coordinate (In a real app we'd map event.pageX to canvas coords)
            let dropX = 100;
            let dropY = 100 + (document.querySelectorAll('.canvas-field').length * 40);
...
print("Studio 4.0 Form-to-Canvas architecture generated successfully.")
