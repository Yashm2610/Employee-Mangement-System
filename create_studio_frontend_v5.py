...
<style>
    ...
    .skeleton-grid {
        ...
        padding: 40px; pointer-events: none; /* Crucial: clicks pass through to dropped elements */
    }
...
<div class="studio-container">
    ...
    <div class="sidebar-left">
        <div class="form-section bg-light text-center py-2">
            ...
            <span class="fs-7 text-muted" style="font-size:10px;">Drag ☰ to drop on the template</span>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Employee ID"><input type="text" class="field-value-input" value="EMP-001"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Employee Name"><input type="text" class="field-value-input" value="Rahul Sharma"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Department"><input type="text" class="field-value-input" value="Engineering"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Designation"><input type="text" class="field-value-input" value="Software Engineer"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Bank Name"><input type="text" class="field-value-input" value="HDFC Bank"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap"><input type="text" class="field-label-input" value="Account No."><input type="text" class="field-value-input" value="******6789"></div></div>
        </div>
        
        <div class="form-section">
            <div class="section-title">Earnings</div>
            <div id="earnings-list">
                <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap border-success"><input type="text" class="field-label-input bg-light" value="Basic Salary"><input type="text" class="field-value-input" value="65,000"></div></div>
        ...
        <div class="form-section mt-auto">
            ...
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap border-primary"><input type="text" class="field-label-input bg-primary text-white" value="Net Payable"><input type="text" class="field-value-input fw-bold" value="113,000"></div></div>
            <div class="field-row drag-source"><i class="bi bi-list field-drag"></i><div class="field-input-wrap border-primary"><input type="text" class="field-label-input bg-primary text-white" value="In Words"><input type="text" class="field-value-input fw-bold" value="One Lakh Thirteen Thousand"></div></div>
        </div>
    </div>
    ...
    <div class="workspace">
        ...
        <div class="canvas-scroll-area">
            <div class="a4-canvas" id="canvas">
                <!-- STRUCTURAL SKELETON (Background layer) -->
...
interact('.drag-source').draggable({
    ...
    listeners: {
            ...
            // Drop coordinates (center of view roughly)
            let dropX = 150;
...
print("Studio 5.0 with A4 Blank Payslip Skeleton Grid created.")
